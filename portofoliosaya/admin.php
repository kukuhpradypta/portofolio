      ...
      <div class="container">
        <a class="navbar-brand" href="dashboard.php" style="margin-left:-5%; padding-right:3%;">Pengguna</a>
         <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color:white; margin-top:-16%; font-size:20px">
            Admin
          </a>
     ...
     <center>
        ...
        while ($cus = mysqli_fetch_array($query)){
          $no_urut++;
            ...
            echo "<td>";
            echo "<a class='btn btn-danger'  href='hapuspesan.php?nama_user=".$cus['nama_user']."'>Hapus Pesan</a> | ";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group row mt-4">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control mb-4 text-dark" id="id_nama" name="nama_galery"  style="border:solid_user2px; border-color:black;">
            </div>
        </div>
